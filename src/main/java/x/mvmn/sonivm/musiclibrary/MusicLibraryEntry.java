...
public class MusicLibraryEntry {
    ...
    public boolean propertiesMatch(MusicLibraryEntry other, List<Function<MusicLibraryEntry, String>> propertyExtractors) {
        boolean result = !propertyExtractors.isEmpty();
        for (Function<MusicLibraryEntry, String> propertyExtractor : propertyExtractors) {
    ...
    public boolean trackPropertiesEqual(MusicLibraryEntry other, Function<MusicLibraryEntry, String> propertyExtractor) {
