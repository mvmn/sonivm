...
public class EqualizerPresetServiceImpl implements EqualizerPresetService {
	...
	static {
		...
		defaultPresets.put("Classical", EqualizerPreset.of(500, invert(new int[] { 500, 500, 500, 500, 500, 500, 700, 700, 700, 760 })));
		...
		defaultPresets.put("Full Bass", EqualizerPreset.of(500, invert(new int[] { 260, 260, 260, 360, 460, 620, 760, 780, 780, 780 })));
